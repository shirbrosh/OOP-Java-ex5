...
/**
 * A SmallerThan Filter object implementing the filter class
 */
public class SmallerThan extends DoubleFilters implements Filter {
    /**
     ...
     */
    public SmallerThan(double TheValueToCompare, boolean isNot){
